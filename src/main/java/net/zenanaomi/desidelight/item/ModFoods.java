...
public class ModFoods {
    ...
    public static final FoodProperties RED_CHILI = new FoodProperties.Builder()
            ...
            .fast()
            .effect(() -> new MobEffectInstance(ModEffects.BURNING, 20, 0, false, false, false), 1.0f)
            .build();
    ...
    public static final FoodProperties BUTTER_CHICKEN = new FoodProperties.Builder()
            ...
            .effect(() -> new MobEffectInstance(vectorwing.farmersdelight.common.registry.ModEffects.NOURISHMENT, 3600, 0, true, true, true), 1.0f)
            .build();

    public static final FoodProperties BIRYANI = new FoodProperties.Builder()
            .nutrition(14)
            .saturationModifier(0.786f)
            .effect(() -> new MobEffectInstance(vectorwing.farmersdelight.common.registry.ModEffects.NOURISHMENT, 6000, 0, true, true, true), 1.0f)
            .effect(() -> new MobEffectInstance(ModEffects.BURNING, 20, 0, false, false, false), 0.05f)
            .build();
    ...
    public static final FoodProperties MISHTI_DOI = new FoodProperties.Builder()
            ...
            .effect(() -> new MobEffectInstance(vectorwing.farmersdelight.common.registry.ModEffects.COMFORT, 600, 0, true, true, true), 1.0f)
            .build();
